 ...
 */
//1. Введите 3 строки с консолью, найдите самую короткую и самую длинную строки. Вывести
//найденные строки и их длина.
//2. Ввести 3 строки с консолью. Упорядочить и вывести строки в порядке возрастания
//измеряет их длину.
//3. Ввести 3 строки с консолью. Вывести на консоль те строки, длина которых меньше
//средний, а также их внешний вид.
//        teachmeskills.by
...
//Не успел разобраться до конца чтобы не образовался ком я решил след урок делать
